...
if( ($_SERVER['REQUEST_METHOD'] == 'GET') && isset($_GET['id']) && $_GET['id']!='' )
{
    ...
    $stmt = $con->prepare('select * from project_list where code=:id');                           
  ...
  foreach ($_POST as $key => $val)
    ...
    if(!isset($MSG)){
       try{
            $stmt = $con->prepare('UPDATE project_list SET
                    p_name = :project_name,                    
            ...
            <div class="panel-body">
                <form class="form-horizontal form-bordered" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" placeholder="프로젝트명을 입력하세요." id="inputPlaceholder" name="project_name" value="<?echo $p_name ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <!-- <div class="input-daterange input-group" data-plugin-datepicker="" data-plugin-options='{"format": "yyyy/mm/dd"}'> -->
                                ...
                                <input type="text" class="form-control" name="start" value="<?echo $date_start; ?>">
                                <span class="input-group-addon">~</span>
                                <input type="text" class="form-control" name="end" value="<?echo $date_end; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" placeholder="현장 위치 입력" name="location" value="<?echo $location; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                                    ...
                                    <?
                                                        ...
                                                        if ($stmt1->rowCount() > 0){
                                                            while($row1=$stmt1->fetch(PDO::FETCH_ASSOC)){
                                                                extract($row1);                               
                                                                ?>
                                    <option value="<?php echo $code; ?>" <?php if($code==$weather1) echo "selected"; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select data-plugin-selectTwo class="form-control populate placeholder" data-plugin-options='{ "placeholder": "Select a State", "allowClear": true }' name="weather2">
                                ...
                                <option value="<? echo $key ?>" <?php if($key==$weather2) echo "selected"; ?>>
                                    ...
                                    <?
                                                        ...
                                                        if ($stmt1->rowCount() > 0){
                                                            while($row1=$stmt1->fetch(PDO::FETCH_ASSOC)){
                                                                extract($row1);                               
                                                                ?>
                                    <option value="<?php echo $loc1."-".$loc2; ?>" <?php if(($loc1."-".$loc2)==$finedust) echo "selected"; ?>>
                        ...
                        <div class="col-md-6">
                            <div data-plugin-spinner="" data-plugin-options='{"value":5, "step":5, "min":5, "max":20 }'>
                                <div class="input-group" style="width:150px;">
                                    <input type="text" class="spinner-input form-control" maxlength="2" readonly="" name="period" value="<?echo $period; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="checkbox-custom checkbox-primary">
                                <input type="checkbox" id="checkboxExample2" name="etc1" <?php if($etc1=="on") echo "checked"; ?>>
                                <label for="checkboxExample2">일 최고기온 불능일 50% 적용</label>
                            </div>
                            <!-- <div class="checkbox-custom checkbox-success">
                                <input type="checkbox" id="checkboxExample3" name="etc2" <?php if($etc2=="on") echo "checked"; ?>>
                                <label for="checkboxExample3">국토부 훈령 법정 공휴일수 적용 </label>
                            </div>
                             --><div class="checkbox-custom checkbox-warning">
                                <input type="checkbox" id="checkboxExample4" name="etc3" <?php if($etc3=="on") echo "checked"; ?>>
